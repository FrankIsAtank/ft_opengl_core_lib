...
// OpenGL headers
#include "coregl/hdc_wrap.h"
#include "coregl/opengl_except.h"
#include "coregl/opengl_headers.h"
#include "coregl/opengl_version.h"
...
ft::gl::context::opengl_context::opengl_context(
    const coregl::hdc_wrap & p_hdc,
...
ft::gl::context::opengl_context::opengl_context(
    const coregl::hdc_wrap & p_hdc, t_legacy_ctor_tag)
{
    FT_ASSERT(m_opengl_ptr != nullptr);
    m_opengl_ptr->device_context = p_hdc.value;
...
int ft::gl::context::opengl_context::assign_pixel_format(const t_pixel_format & p_format)
{
...
std::pair<int, int> ft::gl::context::opengl_context::get_version() const
{
    return {
        coregl::g_opengl_version.major,
        coregl::g_opengl_version.minor
    };
}


// Get the opengl handles for this context
const ft::gl::context::opengl_context_members & 
ft::gl::context::opengl_context::get_handles() const
{
    FT_ASSERT(m_opengl_ptr != nullptr);
    return *m_opengl_ptr;
}
...
void ft::gl::context::opengl_context::clear_frame(const color<float> & p_color)
{
    auto active = make_current{ *this };
...
namespace {
    const std::map<ft::gl::context::opengl_context::t_polygon_mode, GLenum> g_polygon_mode_map = {
        {ft::gl::context::opengl_context::t_polygon_mode::point, GL_POINT},
        {ft::gl::context::opengl_context::t_polygon_mode::line, GL_LINE},
        {ft::gl::context::opengl_context::t_polygon_mode::fill, GL_FILL}
    };
};  // anonymous namespace

// Set the polygon render mode
void ft::gl::context::opengl_context::set_polygon_mode(const t_polygon_mode p_mode)
{
    auto active = make_current{ *this };
...
ft::gl::context::opengl_context::t_polygon_mode
ft::gl::context::opengl_context::get_polygon_mode() const
{
...
namespace {
    const std::map<ft::gl::context::opengl_context::t_culling_mode, GLenum> g_culling_mode_map = {
        {ft::gl::context::opengl_context::t_culling_mode::back_culling, GL_BACK},
        {ft::gl::context::opengl_context::t_culling_mode::front_culling, GL_FRONT},
        {ft::gl::context::opengl_context::t_culling_mode::full_culling, GL_FRONT_AND_BACK}
    };
};  // anonymous namespace

// Set the culling render mode
void ft::gl::context::opengl_context::set_culling_mode(const t_culling_mode p_mode)
{
    auto active = make_current{ *this };
...
ft::gl::context::opengl_context::t_culling_mode
ft::gl::context::opengl_context::get_culling_mode() const
{
...
void ft::gl::context::opengl_context::set_depth_test_mode(
...
ft::gl::context::opengl_context::t_depth_buffering
ft::gl::context::opengl_context::get_depth_test_mode() const
{
...
void ft::gl::context::opengl_context::set_blending_mode(const t_blend_mode p_mode)
{
...
ft::gl::context::opengl_context::t_blend_mode
ft::gl::context::opengl_context::get_blending_mode() const
{
...
std::vector<int> ft::gl::context::opengl_context::make_pixel_attributs(
    const t_pixel_format & p_format)
{
...
void ft::gl::context::opengl_context::activate() const
{
...
void ft::gl::context::opengl_context::deactivate() const
{
