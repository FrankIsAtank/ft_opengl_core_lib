...
// Constructor
ft::gl::rf::render_frame_impl::render_frame_impl(const t_render_frame_params & p_params) :
    m_params(p_params)
{
    // Create the window
    initialize();
    ...
    m_opengl_context = std::make_unique<ft::gl::context::opengl_context>(
...
ft::gl::rf::render_frame_impl::get_opengl_context()
{
...
void ft::gl::rf::render_frame_impl::display_frame()
{
...
ft::gl::rf::render_frame_impl::get_opengl_context() const
{
    FT_ASSERT(m_opengl_context != nullptr);
    return *m_opengl_context;
}
...
void ft::gl::rf::render_frame_impl::set_visible(const bool p_visible)
{
...
bool ft::gl::rf::render_frame_impl::is_visible() const
{
    return m_visible;
}
...
void ft::gl::rf::render_frame_impl::initialize()
{
...
void ft::gl::rf::render_frame_impl::set_dummy_pixel_format()
{
...
ft::gl::coregl::hdc_wrap
ft::gl::rf::render_frame_impl::get_context() const
{
...
::LRESULT 
ft::gl::rf::render_frame_impl::window_proc(::UINT p_msg, ::WPARAM p_w_params, ::LPARAM p_l_params)
{
...
ft::gl::rf::render_frame_impl::render_frame_impl(const t_render_frame_params & p_params, t_dummy_ctor_tag) :
    m_params(p_params)
{
    // Create the window
    initialize();
    ...
    // Create an opengl context for this render frame
    m_opengl_context = std::make_unique<ft::gl::context::opengl_context>(
        get_context(), ft::gl::context::opengl_context::t_legacy_ctor_tag{});
}


// Initialize the window class if it hasn't been initialized yet and get a pointer to it
std::shared_ptr<ft::gl::rf::window_class_win32>
ft::gl::rf::render_frame_impl::get_class_obj(const t_render_frame_params & p_params)
{
    static std::mutex instance_lock;
    static std::weak_ptr<ft::gl::rf::window_class_win32> instance;
...
::DWORD ft::gl::rf::render_frame_impl::make_style(const t_render_frame_params & p_params)
{
    return 0;
}
...
::DWORD ft::gl::rf::render_frame_impl::make_style_ext(const t_render_frame_params & p_params)
{
    return 0;
}
...
::HINSTANCE ft::gl::rf::render_frame_impl::get_host_handle(const t_render_frame_params & p_params)
{
    (void)p_params;
