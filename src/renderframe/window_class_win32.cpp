...
// Define statics
std::recursive_mutex ft::gl::rf::window_class_win32::s_map_mutex;
std::map<::HWND, ft::gl::rf::window_class_win32::t_window_proc> ft::gl::rf::window_class_win32::s_instance_map;


// Constructor
ft::gl::rf::window_class_win32::window_class_win32(t_params && p_params)
{ 
...
// Destructor
ft::gl::rf::window_class_win32::~window_class_win32() noexcept
{
    if (m_atom.has_value())
    {
...
::ATOM ft::gl::rf::window_class_win32::get_atom() const
{
    return *m_atom;
}
...
// Get this class' name
const std::string & ft::gl::rf::window_class_win32::get_name() const
{
...
void ft::gl::rf::window_class_win32::register_window(::HWND p_window_handle, t_window_proc p_proc)
{
...
void ft::gl::rf::window_class_win32::unregister_window(::HWND p_window_handle)
{
    std::lock_guard<decltype(s_map_mutex)> lock{ s_map_mutex };
...
::ATOM ft::gl::rf::window_class_win32::register_class(const t_params & p_params)
{
...
::UINT ft::gl::rf::window_class_win32::make_class_style(const t_params & p_params)
{
...
// Define a class icon
::HICON ft::gl::rf::window_class_win32::make_icon_handle(const t_params & p_params)
{
...
::HICON ft::gl::rf::window_class_win32::make_small_icon_handle(const t_params & p_params)
{
...
::HCURSOR ft::gl::rf::window_class_win32::make_cursor_handle(const t_params & p_params)
{
...
::HBRUSH ft::gl::rf::window_class_win32::make_brush(const t_params & p_params)
{
...
::LRESULT ft::gl::rf::window_class_win32::WindowProc(
    ::HWND hwnd,
    ::UINT uMsg,
    ::WPARAM wParam,
    ::LPARAM lParam)
